...
unsigned long misterOnTime = 50000;
unsigned long misterOffTime = 30000;
unsigned long paramReadingInterval = 20000;
unsigned long paramReadingMillis = 0;
unsigned long phReadingMillis = 0;
unsigned long phReadingInterval = 20000;
...
void dbGetSendFirestore(unsigned long currentMillis) {
  if (currentMillis - dbUpdateMillis >= 10000) {
    ...
    // saveMisterConfigSPIFFS(getMistOn(), getMistOff());
